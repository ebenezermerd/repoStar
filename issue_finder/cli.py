...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-repositories", type=int, default=10)
    parser.add_argument("--max-repo-search-pages", type=int, default=1)
    parser.add_argument("--issues-per-repository", type=int, default=30)
    parser.add_argument("--max-issue-pages", type=int, default=1)
